...
export async function compileContract(
  ...
  try {
    ...
    // Always return the compilation result, even if it failed
    // This allows us to show the actual compiler errors in the terminal
    if (!response.data) {
      throw new Error(response.error?.message || 'No compilation data received');
    }
