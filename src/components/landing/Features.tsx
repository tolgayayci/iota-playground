...
const FEATURES = [
  {
    icon: Rocket,
    title: 'Instant Move Project Setup',
    description: 'Start with a clean Move project or choose from our collection of templates including NFTs, Tokens, and DeFi modules.',
  ...
  },
  {
    ...
    description: 'Write Move smart contracts with full syntax highlighting, auto-completion, and IOTA-specific modules.',
    ...
    preview: (
      <div className="relative overflow-hidden rounded-lg border bg-muted h-[200px]">
        ...
        <div className="p-6 font-mono text-sm">
          <div className="text-blue-500">module hello::greetings</div>
          <div className="text-purple-500">public fun</div>
          <div className="pl-4">greet(name: String): String {'{'}</div>
          <div className="pl-8 text-green-500">// Move code here</div>
  ...
  {
    icon: Terminal,
    title: 'Zero-Setup Move Compilation',
    description: 'Compile your Move modules instantly. No local toolchain setup needed – runs iota move build in the cloud.',
      ...
      <div className="relative overflow-hidden rounded-lg border bg-muted h-[200px]">
        ...
        <div className="p-4 font-mono text-xs">
          <pre className="whitespace-pre-wrap space-y-1">
            <div className="text-muted-foreground">Building Move project with Move.toml v1.0.0</div>
            <div>
            ...
            <div className="text-muted-foreground">File used for deployment: ./Move.toml</div>
  ...
  {
    icon: Network,
    title: '1-Click IOTA Deployment',
    description: 'Deploy directly to IOTA Testnet or Mainnet. Auto-configured RPC endpoints and integrated faucet.',
        ...
        <div className="p-4">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-muted-foreground">IOTA Testnet</div>
              </div>
            </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between p-2 rounded-lg bg-background/50 border">
              ...
              <code className="text-xs font-mono text-muted-foreground">Network: IOTA</code>
            </div>
            ...
            <div className="flex items-center justify-between p-2 rounded-lg bg-background/50 border">
              ...
              <div className="text-sm">0.001 IOTA</div>
            </div>
          </div>
        </div>
      </div>
  ...
  {
    icon: PlayCircle,
    title: 'Interactive Module Testing',
    description: 'Execute Move functions, create PTBs, and monitor transaction history. Auto-generated interface from your Move modules.',
  ...
  },
  {
    ...
    description: 'Share your Move projects with read-only links. Invite team members to view and collaborate on your modules.',
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-2">
              <div className="flex-1 rounded-md bg-background/50 p-2 text-xs font-mono text-muted-foreground truncate">
                https://iotaplay.app/p/token-module-xyz123
              </div>
    ...
    <section id="features" className="container mx-auto py-24 lg:py-32">
      ...
      >
        <h2 className="text-3xl font-bold tracking-tight mb-4">
          Everything You Need to Build on IOTA
        </h2>
        <p className="text-lg text-muted-foreground">
          A complete development environment for Move smart contracts,
