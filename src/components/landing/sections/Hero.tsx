  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      particles.forEach((particle) => {
        ...
        // Draw particle with IOTA colors (cyan/blue)
        ctx.beginPath();
        ctx.arc(particle.x, particle.y, particle.size, 0, Math.PI * 2);
        ctx.fillStyle = `rgba(59, 130, 246, ${particle.opacity})`; // IOTA blue
        ctx.fill();
      ...
      <div className="relative z-10 w-full px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl lg:text-2xl text-gray-600 mb-12 max-w-3xl mx-auto">
            From zero to deployed Move contract in 30 seconds.
            <br />
          ...
          <div className="flex flex-wrap gap-4 justify-center mb-16">
            <Button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white px-10 h-14 text-lg group shadow-xl shadow-blue-600/25 hover:shadow-2xl hover:shadow-blue-600/30 transition-all hover:scale-105"
            >
              Start Building Now
          ...
          <div className="flex flex-wrap justify-center gap-8 lg:gap-16">
            ...
            <div className="flex items-center gap-3 hover:scale-105 transition-transform">
              ...
              <div className="text-left">
                ...
                <div className="text-sm text-gray-600">Move Standards</div>
              </div>
            </div>
          </div>
        </div>
