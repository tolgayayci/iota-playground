  ...
  useEffect(() => {
    ...
    for (let i = 0; i < 15; i++) {
      lines.push({
        ...
        color: i % 2 === 0 ? '239, 68, 68' : '59, 130, 246' // red vs IOTA blue
      });
    }
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="max-w-3xl mb-20">
          ...
          <p className="text-xl text-gray-500 font-light">
            Traditional setup: 30 minutes. IOTA Playground: 30 seconds. The math is simple.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 mb-32 transition-all duration-700 hover:gap-20">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4 group hover:translate-x-2 transition-transform duration-300">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-gray-500">You have a brilliant idea for an IOTA smart contract</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 group hover:translate-x-2 transition-transform duration-300 delay-75">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-gray-500">Installing IOTA SDK, Move compiler, dependencies...</div>
                </div>
              </div>
          ...
          <div>
            <div className="mb-8">
              ...
              <h3 className="text-3xl font-semibold text-gray-900">IOTA Playground</h3>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4 group hover:translate-x-2 transition-transform duration-300">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-gray-500">Visit iotaplay.app</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 group hover:translate-x-2 transition-transform duration-300 delay-100">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-gray-500">One-click compilation with iota move build</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 group hover:translate-x-2 transition-transform duration-300 delay-150">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-gray-500">Your contract is on IOTA testnet</div>
                </div>
              </div>
            </div>
        ...
        <div className="mb-24">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-6 bg-gray-50 rounded-2xl hover:scale-105 transition-transform duration-300 cursor-default">
              ...
              <p className="text-gray-500 text-sm">
                No ABI copy-pasting. No interface building. Just click and interact with your deployed IOTA contracts instantly.
              </p>
            </div>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            <div>
              ...
              <p className="text-gray-500">
                Join 100+ developers building on IOTA Protocol
              </p>
            </div>
            <button
              onClick={() => {
