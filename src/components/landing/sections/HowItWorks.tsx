              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">Create a new IOTA Move contract from scratch</div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">Start with Token, NFT, or custom Move templates</div>
                  </div>
                </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-3 mt-6">
                      ...
                      <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                        ...
                        <span className="text-sm text-gray-700">NFT Collection</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="pt-4 border-t border-gray-200">
                      <div className="h-10 bg-blue-500 rounded-lg flex items-center justify-center">
                        <span className="text-white text-sm font-medium">Deploy to IOTA Testnet</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">Professional code editor with Move syntax support</div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">Deploy to IOTA testnet instantly</div>
                  </div>
                </div>
                  ...
                  <div className="space-y-6">
                    <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-blue-700 font-medium">Contract deployed successfully</span>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-200">
                          <span className="text-sm text-gray-700">mint()</span>
                    ...
                    <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                      <div className="space-y-2">
                        ...
                        <div className="text-xs text-green-600">Result: Success</div>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="border-t border-gray-100 pt-20">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Deploy to IOTA</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-2">iota move build Integration</h4>
              <p className="text-gray-600 leading-relaxed">
                Build and optimize<br />
                contracts with iota move build
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">
                Token, NFT, Counter,<br />
                Multi-sig - ready to use
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-32 pt-20 border-t border-gray-100">
          <div className="text-center">
            <h3 className="text-2xl font-semibold text-gray-900 mb-8">
              Ready to build something amazing on IOTA?
            </h3>
