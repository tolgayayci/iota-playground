...
const USER_TYPES = [
  ...
  },
  {
    id: 'newbies',
    icon: GraduationCap,
    title: 'Move Beginners',
    description: 'Start your Move journey with a guided, hassle-free experience on IOTA.',
    benefits: [
      {
        icon: BookOpen,
  ...
  },
  {
    ...
    description: 'Streamlined environment for efficient Move development on IOTA.',
    benefits: [
      {
        icon: Rocket,
