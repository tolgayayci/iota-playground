...
const WELCOME_STEPS = [
  {
    Icon: Sparkles,
    title: "Welcome to IOTA Playground!",
    description: "Your all-in-one platform for building, testing, and deploying Move smart contracts on IOTA. Let's get you started with a quick tour.",
    features: [
      "Zero setup required - everything runs in your browser",
      "Pre-configured development environment",
      "Real-time compilation and testing",
      "One-click deployment to IOTA",
    ],
  },
  {
    Icon: FileCode2,
    title: "Your First Projects",
    description: "We've created starter projects to help you get familiar with Move development:",
    features: [
      "Hello World - A simple Move module to understand the basics",
      "NFT Collection - Learn to create digital assets",
      "Token Contract - Build fungible tokens on IOTA",
      "Use them as templates for your own modules",
    ],
  },
  {
    Icon: Terminal,
    title: "Move Development",
    description: "Write and compile your Move modules with our powerful editor:",
    features: [
      "Syntax highlighting and auto-completion",
      "Real-time error checking",
      "Built-in Move compiler",
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] flex flex-col">
        <DialogHeader>
          <div className="flex items-center justify-center gap-3 mb-2">
            ...
            <DialogTitle className="text-2xl">Welcome to IOTA Playground!</DialogTitle>
          </div>
          <DialogDescription className="text-center">
            Let's get you started with Move development on IOTA
          </DialogDescription>
        </DialogHeader>
