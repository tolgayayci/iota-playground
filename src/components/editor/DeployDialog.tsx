...
import { prepareDeployment, deployWithPlaygroundWallet } from '@/lib/deploy';
...
// Temporary DeploymentResult type until we update the main types
...
export function DeployDialog({
  ...
  const isWalletConnected = !!(currentAccount?.address || playgroundAddress);
      ...
      <DialogContent className="sm:max-w-[800px]">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Deploy to IOTA {network === 'testnet' ? 'Testnet' : 'Mainnet'}
          </DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-3">
            <h4 className="text-sm font-medium">Wallet Connection</h4>
            {isWalletConnected ? (
              <div className="flex items-center justify-between p-4 rounded-lg bg-green-500/5 border border-green-500/20">
                ...
                <Badge variant="outline">
                  {isPlaygroundWallet ? 'Playground' : 'External'}
                </Badge>
              </div>
            ) : (
              <Alert>
                ...
                <AlertDescription>
                  You need to connect a wallet to deploy contracts.
                  <Button 
                    variant="link" 
                    className="px-2"
          ...
          <div className="flex items-center gap-3 p-4 rounded-lg bg-muted">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Your package will be deployed to IOTA {network === 'testnet' ? 'Testnet' : 'Mainnet'}
              </p>
            </div>
          </div>
